...
file_err:
    ...
    ; **
    ;   Doesn't work, intended to print the
    ;   hex value of the file error code in ax
    ; **
    ; call byte_to_hex
    ; mov dl, ah
    ; print_char dl
...
byte_to_hex proc
    ; take byte in al, output higher 4 bit's
    ; hex value in ah and the lower 4 bit's in al
    mov ah, al
    shr ah, 4
    and al, 15
